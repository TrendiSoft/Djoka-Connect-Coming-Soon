...
{
    $('#subscribe').attachHint('Enter your email to receive Djoka Connect news and updates');
    $('[name=contact_name]').attachHint('Name');
    $('[name=contact_email]').attachHint('Email');
    $('[name=contact_subject]').attachHint('Select a Subject');
        ...
        $.ajax({
            ...
            success: function(response){
                if(response){
                    ...
                    {
                        $('#subscribe').val('');
						showMessage('You will be notified about Djoka Connect news and updates. Thank you!');
        ...
        success: function(response){
            if(response){
                ...
                if(responseObj.ResponseData)
					...
					showMessage('Your message was sent. You will get a feedback from us within the 72 business hours. Thank you!');
